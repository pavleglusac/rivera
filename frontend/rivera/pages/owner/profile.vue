...
<div>
  ...
  <b-container class="bv-example-row" style="max-width: 700px;">
    <ClientProfile/>
    <b-card style="margin-bottom: 10px">
      <b-tabs content-class="mt-3" justified>
        ...
        <b-tab title="Loyalty program"><LoyaltyOwner/></b-tab>
      </b-tabs>
    </b-card>
  </b-container>
</div>  
...
import LoyaltyOwner from '../../components/client/LoyaltyOwner.vue';
export default {
  components: { Navbar, ClientProfile, ProfileData, PasswordChange, LoyaltyOwner },
}
</script>
