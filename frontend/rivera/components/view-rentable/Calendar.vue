  ...
  methods: {
    ...
    sendPattern(patterns) {
      let to_send={
        ...
        rentableId: this.$route.params.cottage,
      };
      let that=this;
      console.log(to_send);
      this.$axios
        .post("/api/cottage/define-availability", JSON.stringify(to_send), {
          headers: {
    ...
    removeAvailabilities() {
      ...
      this.$axios
        .post(
          `/api/cottage/remove-availabilities?id=${this.$route.params.cottage}` ,
          {
            headers: {
              "Content-Type": "application/json",
            },
    ...
    async getAvailabilities() {
      ...
      this.$axios
        .get(
          "/api/cottage/get-availabilities",
          {
            params: {
              ...
              cottageId: this.$route.params.cottage,
            },
          },
          {
            headers: {
