        ...
        <div class="p-2">
          <form>
            <div class="form-row">
              ...
              <div class="form-group col-md-2" v-if="adding == 'adventure'">
                <b-button
                  size="sm"
                  class="w-100"
                  style="background-color: #16c79a; border: 1px solid #16c79a"
                  @click="addModal"
                  >Add adventure</b-button
                >
              </div>
              <div class="form-group col-md-2" v-else-if="adding == 'cottage'">
                <b-button
                  size="sm"
                  class="w-100"
                  style="background-color: #16c79a; border: 1px solid #16c79a"
